...
<body class="bg-dark dark:bg-zinc-900">
    ...
    <div class="body container-zon mt-2 px-0">
        ...
        ?>
        <h1 class="category-title mb-3 mt-12 text-center"><?php echo $name ?></h1>
        ...
        <?php if (Exist_Data("zon_games", "game_category='$name'") !== 0) { ?>
            ...
            <div class="zon-loader grid mt-16 mx-2">
                <a class="card-info bg-gray-200 hover:bg-gray-300 transition duration-300 box rounded-xl shadow-md hover:shadow-lg overflow-hidden"></a>
                <a class="card-info bg-gray-200 hover:bg-gray-300 transition duration-300 box rounded-xl shadow-md hover:shadow-lg overflow-hidden"></a>
                <a class="card-info bg-gray-200 hover:bg-gray-300 transition duration-300 box rounded-xl shadow-md hover:shadow-lg overflow-hidden"></a>
                <a class="card-info bg-gray-200 hover:bg-gray-300 transition duration-300 box rounded-xl shadow-md hover:shadow-lg overflow-hidden"></a>
                <a class="card-info bg-gray-200 hover:bg-gray-300 transition duration-300 box rounded-xl shadow-md hover:shadow-lg overflow-hidden"></a>
...
<script>
    ...
    function LoadData() {
        ...
        $.post("<?php echo $site_url ?>includes/ajax/cd.php", {
            page: page_no,
            name: c_n
        }, (data) => {
            // console.log(data);
