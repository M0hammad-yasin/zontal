...
<head>
    ...
    <style>
        ...
        .action-button {
            color: var(--act-button-text-color) !important;
            background-color: var(--act-button-bg-color) !important
        }
        ...
        .light-color,
        .link-color a {
            color: var(--header-links-color) !important
        }

        .cat-box {
            background-color: var(--cate-bg-color) !important;
            color: var(--cate-text-color) !important
        }
        ...
        .sidebar .cat-item-container a:hover {
        ...
        /* Hover Effects */
        .card-info:hover .card-body img {
            transform: scale(1.1);
            /* Enlarges the image smoothly */
        }

        .card-info:hover .relative {
            background-color: #d1d5db;
            /* Changes background color of the info section */
        ...
        category
        /////////////////////*/
        /* Custom styling for category title */
        .category-title-container {
            margin-bottom: 1.5rem;
            /* Space between category title and games */
        }
        ...
        .category-title {
            ...
            /* Optional: Capitalize category name */
        }

        /* Make sure category title is centered and adjusted on smaller screens */
        ...
        .blur-overlay {
            background: rgba(255, 255, 255, .401);
            z-index: 99;
        ...
        .offcanvas-menu {
            ...
            top: 0;
            width: 300px;
            background-color: var(--offcanvas-menu-bg-color);
            height: 100%;
            z-index: 999;
